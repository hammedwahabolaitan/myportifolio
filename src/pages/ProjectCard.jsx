  ...
  return (
    <div className="work border-2 border-[#bbb5b5] shadow w-full h-auto pb-5 cursor-pointer">
      ...
      <div className="text-center px-4">
        <h2 className="text-base leading-loose pt-3 pb-2 drop-shadow uppercase">{title}</h2>
        <p className="leading-loose text-[13px] pb-2 text-black opacity-50 ">{description}</p>
